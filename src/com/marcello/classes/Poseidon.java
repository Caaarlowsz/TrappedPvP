...
public class Poseidon implements Listener
{
    ...
    public void Bater(final EntityDamageByEntityEvent e) {
        if (e.getEntity() instanceof Player && e.getDamager() instanceof Player) {
            ...
            if (KitAPI.getKit(t) == "Poseidon" && t.getItemInHand().getType() == Material.WOOD_SWORD && t.getLocation().getBlock().isLiquid() && t.getLocation().getBlock().getType().name().contains("WATER")) {
    ...
    public void Andar(final PlayerMoveEvent e) {
        ...
        if (KitAPI.getKit(p) == "Poseidon" && p.getLocation().getBlock().isLiquid() && p.getLocation().getBlock().getType().name().contains("WATER")) {
