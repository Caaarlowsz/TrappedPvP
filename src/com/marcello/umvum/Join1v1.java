...
public class Join1v1 implements Listener {
	...
	static {
		...
		Join1v1.Item_ = Join1v1.Item.createItem(Material.BLAZE_ROD, "BLAZE_ROD", "§aDesafiar 1v1 §8(Clique)",
				new String[0], 1, (short) 0);
		Join1v1.Cinza = Join1v1.Item.createItem(Material.INK_SACK, "INK_SACK", "§aDuelo Rapido §8(Clique)",
