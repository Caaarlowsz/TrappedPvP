...
public class Score
{
    ...
    static {
        Score.animation = new String[] { "§b§lTRAPPED", "§b§lTRAPPED", "§f§lT§b§lRAPPED", "§b§lT§f§lR§b§lAPPED", "§b§lTR§f§lA§b§lPPED", "§b§lTRA§F§LP§B§LPED", "§b§lTRAP§f§lP§b§lED", "§b§lTRAPP§f§lE§b§lD", "§b§lTRAPPED§f§lMC", "§b§lTRAPPED", "§bTRAPPED§f§lMC", "§b§lTRAPPED", "§0§l§kTRAPPED§f§lMC" };
        Score.animationI = 0;
    }
    ...
    public static void setScore(final Player p) {
        ...
        online.setSuffix(String.valueOf(String.valueOf(Bukkit.getOnlinePlayers().length)) + "§3/§3" + Bukkit.getMaxPlayers());
    ...
    public static void updateScore(final Player p) {
        ...
        if (score.getObjective("dummy") != null) {
            ...
            final Team ping = score.getTeam("ping");
            ...
            money.setSuffix("0");
            kit.setSuffix(KitAPI.getKit(p));
            online.setSuffix(String.valueOf(String.valueOf(Bukkit.getOnlinePlayers().length)) + "§6/§e" + Bukkit.getMaxPlayers());
        }
    }
