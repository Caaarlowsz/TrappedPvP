...
public class LojaPerm implements Listener, CommandExecutor
{
    ...
    public void Clicar(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && p.getItemInHand().getType() == Material.DIAMOND && p.getItemInHand().getItemMeta().getDisplayName().equalsIgnoreCase("§bLoja §7(Clique)")) {
            p.chat("/lojaperm");
        }
    }
        ...
        if (e.getCurrentItem() != null && e.getCurrentItem().getItemMeta() != null) {
            ...
            if (e.getCurrentItem().isSimilar(LojaPerm.prisma)) {
                if (KillsDeathsMoney.getMoney(p) >= 15000) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add tag.reverse");
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        LojaPerm.prismameta.setLore((List)Lore("§7» §b§l15.000 §7Coins"));
        ...
        LojaPerm.mainmeta.setLore((List)Lore("§5Isso ser\u00e1 adicionado em breve."));
        ...
        LojaPerm.closemeta.setLore((List)Lore("§7Feche o menu"));
        ...
        LojaPerm.cormeta.setLore((List)Lore("§7» §b§l10.000 §7Coins"));
