    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (args.length == 0 && cmd.getName().equalsIgnoreCase("atualizar")) {
            if (p.hasPermission("cmd.atualizar")) {
                ...
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a20 §7segundos");
                    }
                }.runTaskLater((Plugin)Main.instance, 200L);
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a10 §7segundos");
                    }
                }.runTaskLater((Plugin)Main.instance, 400L);
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a5 §7segundos");
                    }
                }.runTaskLater((Plugin)Main.instance, 500L);
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a4 §7segundos");
                    }
                }.runTaskLater((Plugin)Main.instance, 520L);
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a3 §7segundos");
                    }
                }.runTaskLater((Plugin)Main.instance, 540L);
                new BukkitRunnable() {
                    public void run() {
                        Bukkit.broadcastMessage("§a§lRELOAD §7Servidor sendo reiniciado automaticamente §a2 §7segundos");
                    }
