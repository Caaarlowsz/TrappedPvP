    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("promover")) {
            ...
            if (kit.equalsIgnoreCase("helper")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Helper");
            ...
            if (kit.equalsIgnoreCase("trial")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Trial");
                Bukkit.broadcastMessage("          §7» §c§lReverse§f§lMC       ");
                Bukkit.broadcastMessage("§7");
                Bukkit.broadcastMessage("§7O Jogador §e" + k.getName() + " §7Foi Promovido!");
            ...
            if (kit.equalsIgnoreCase("mod")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Mod");
                Bukkit.broadcastMessage("          §7» §c§lReverse§f§lMC       ");
                Bukkit.broadcastMessage("§7");
                Bukkit.broadcastMessage("§7O Jogador §e" + k.getName() + " §7Foi Promovido!");
            ...
            if (kit.equalsIgnoreCase("admin")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Admin");
                Bukkit.broadcastMessage("          §7» §c§lReverse§f§lMC       ");
                Bukkit.broadcastMessage("§7");
                Bukkit.broadcastMessage("§7O Jogador §e" + k.getName() + " §7Foi Promovido!");
            ...
            if (kit.equalsIgnoreCase("gerente")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Gerente");
                Bukkit.broadcastMessage("          §7» §c§lReverse§f§lMC       ");
                Bukkit.broadcastMessage("§7");
                Bukkit.broadcastMessage("§7O Jogador §e" + k.getName() + " §7Foi Promovido!");
            ...
            if (kit.equalsIgnoreCase("dono")) {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + k.getName() + " group set Dono");
                Bukkit.broadcastMessage("          §7» §c§lReverse§f§lMC       ");
                Bukkit.broadcastMessage("§7");
                Bukkit.broadcastMessage("§7O Jogador §e" + k.getName() + " §7Foi Promovido!");
