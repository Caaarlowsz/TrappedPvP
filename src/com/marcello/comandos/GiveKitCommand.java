	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("givekit")) {
			...
			if (kit.equalsIgnoreCase("Boxer")) {
				p.sendMessage("§c§lKIT §7O kit §5§lBOXER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
						"pex user " + jogador.getName() + " add kit.boxer");
				return true;
			}
			if (kit.equalsIgnoreCase("Ajnin")) {
				p.sendMessage("§c§lKIT §7O kit §5§lAJNIN §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Switcher")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSWITCHER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Thresh")) {
				p.sendMessage("§c§lKIT §7O kit §5§lTHRESH §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("BurstMaster")) {
				p.sendMessage("§c§lKIT §7O kit §5§lBUSRSTMASTER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Monk")) {
				p.sendMessage("§c§lKIT §7O kit §5§lMONK §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Camel")) {
				p.sendMessage("§c§lKIT §7O kit §5§lCAMEL §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Deshfire")) {
				p.sendMessage("§c§lKIT §7O kit §5§lDESHFIRE §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Deshviper")) {
				p.sendMessage("§c§lKIT §7O kit §5§lDESHVIPER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Fisherman")) {
				p.sendMessage("§c§lKIT §7O kit §5§lFISHERMAN §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Forcefield")) {
				p.sendMessage("§c§lKIT §7O kit §5§lFORCEFIELD §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Gladiator")) {
				p.sendMessage("§c§lKIT §7O kit §5§lGLADIATOR §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Hulk")) {
				p.sendMessage("§c§lKIT §7O kit §5§lHULK §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Kangaroo")) {
				p.sendMessage("§c§lKIT §7O kit §5§lKANGAROO §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Madman")) {
				p.sendMessage("§c§lKIT §7O kit §5§lMADMAN §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Ninja")) {
				p.sendMessage("§c§lKIT §7O kit §5§lNINJA §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Phantom")) {
				p.sendMessage("§c§lKIT §7O kit §5§lPHANTOM §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Poseidon")) {
				p.sendMessage("§c§lKIT §7O kit §5§lPOSEIDON §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Reaper")) {
				p.sendMessage("§c§lKIT §7O kit §5§lREAPER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Ryu")) {
				p.sendMessage("§c§lKIT §7O kit §5§lRYU §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Seya")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSEYA §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Snail")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSNAIL §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Sonic")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSONIC §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Specialist")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSPECIALIST §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Stomper")) {
				p.sendMessage("§c§lKIT §7O kit §5§lSTOMPER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Thor")) {
				p.sendMessage("§c§lKIT §7O kit §5§lTHOR §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("TimeLord")) {
				p.sendMessage("§c§lKIT §7O kit §5§lTIMELORD §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Titan")) {
				p.sendMessage("§c§lKIT §7O kit §5§lTITAN §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Turtle")) {
				p.sendMessage("§c§lKIT §7O kit §5§lTURTLE §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Urgal")) {
				p.sendMessage("§c§lKIT §7O kit §5§lURGAL §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Viking")) {
				p.sendMessage("§c§lKIT §7O kit §5§lVIIKNG §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
			...
			if (kit.equalsIgnoreCase("Viper")) {
				p.sendMessage("§c§lKIT §7O kit §5§lVIPER §7Foi dado ao jogador " + jogador.getName() + "§7(§5"
						+ jogador.getUniqueId() + "§7)");
				Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
