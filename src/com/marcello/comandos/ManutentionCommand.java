            ...
            if (args.length == 1) {
                if (args[0].equalsIgnoreCase("on")) {
                    if (ManutentionCommand.manutencao) {
                        p.sendMessage("§4§LMANUTEN\u00c7\u00c2O §7O servidor j\u00e1 est\u00e1 no modo manuten\u00e7\u00e3o");
                        return true;
                    }
                    Bukkit.broadcastMessage("§4§LMANUTEN\u00c7\u00c2O §7Servidor entrando em Manuten\u00e7\u00e3o! Todos ser\u00e3o Kickados em §f5 Segundos!");
                    ...
                    if (!ManutentionCommand.manutencao) {
                        p.sendMessage("§4§LMANUTEN\u00c7\u00c2O §7O Servidor n\u00e3o est\u00e1 em modo manuten\u00e7ao!");
                        return true;
                    }
                    ManutentionCommand.manutencao = false;
