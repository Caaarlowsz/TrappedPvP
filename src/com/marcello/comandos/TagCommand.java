    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (args.length == 0) {
            if (p.hasPermission("tag.dono")) {
                ...
                p.sendMessage("§E");
                ChatInterativo.Comando(p.getName(), "§4§lDONO", "/tag dono", "§e(Clique) §7§7Exemplo: §4§lDONO §4" + p.getName());
                ChatInterativo.Comando(p.getName(), "§3§lDEVELOPER", "/tag developer", "§e(Clique) §7§7Exemplo: §3§lDEVELOPER §3" + p.getName());
                ChatInterativo.Comando(p.getName(), "§c§lADMIN", "/tag admin", "§e(Clique) §7§7Exemplo: §c§lADMIN §c" + p.getName());
                ChatInterativo.Comando(p.getName(), "§c§lGERENTE", "/tag gerente", "§e(Clique) §7§7Exemplo: §c§lGERENTE §c" + p.getName());
                ChatInterativo.Comando(p.getName(), "§5§lMOD+", "/tag modplus", "§e(Clique) §7§7Exemplo: §5§lMODPLUS §5" + p.getName());
                ChatInterativo.Comando(p.getName(), "§5§lMOD", "/tag mod", "§e(Clique) §7§7Exemplo: §5§lMOD §5" + p.getName());
                ChatInterativo.Comando(p.getName(), "§5§lTRIAL", "/tag trial", "§e(Clique) §7§7Exemplo: §5§lTRIAL §5" + p.getName());
                ChatInterativo.Comando(p.getName(), "§9§lHELPER", "/tag helper", "§e(Clique) §7§7Exemplo: §9§lHELPER §9" + p.getName());
                ChatInterativo.Comando(p.getName(), "§e§lBUILDER", "/tag builder", "§e(Clique) §7§7Exemplo: §e§lBUILDER §e" + p.getName());
                ChatInterativo.Comando(p.getName(), "§3§lYOUTUBER+", "/tag youtuber+", "§e(Clique) §7§7Exemplo: §3§lYOUTUBER+ §3" + p.getName());
                ChatInterativo.Comando(p.getName(), "§b§lYOUTUBER", "/tag youtuber", "§e(Clique) §7§7Exemplo: §b§lYOUTUBER §b" + p.getName());
                ChatInterativo.Comando(p.getName(), "§d§lULTIMATE", "/tag ultimate", "§e(Clique) §7§7Exemplo: §D§lULTIMATE §d" + p.getName());
                ChatInterativo.Comando(p.getName(), "§6§lPREMIUM", "/tag premium", "§e(Clique) §7§7Exemplo: §6§lPREMIUM §6" + p.getName());
                ChatInterativo.Comando(p.getName(), "§a§lLIGHT", "/tag light", "§e(Clique) §7§7Exemplo: §a§lLIGHT §a" + p.getName());
                ChatInterativo.Comando(p.getName(), "§7§lNORMAL", "/tag normal", "§e(Clique) §7§7Exemplo: §7" + p.getName());
                return true;
            }
            if (p.hasPermission("tag.gerente")) {
                ...
                ChatInterativo.Comando(p.getName(), "§e§lBUILDER", "/tag builder", "§e(Clique) §7§7Exemplo: §e§lBUILDER §e" + p.getName());
                ChatInterativo.Comando(p.getName(), "§3§lYOUTUBER+", "/tag youtuber+", "§e(Clique) §7§7Exemplo: §3§lYOUTUBER+ §3" + p.getName());
                ChatInterativo.Comando(p.getName(), "§b§lYOUTUBER", "/tag youtuber", "§e(Clique) §7§7Exemplo: §b§lYOUTUBER §7" + p.getName());
                ChatInterativo.Comando(p.getName(), "§d§lULTIMATE", "/tag ultimate", "§e(Clique) §7§7Exemplo: §D§lULTIMATE §d" + p.getName());
                ChatInterativo.Comando(p.getName(), "§6§lPREMIUM", "/tag premium", "§e(Clique) §7§7Exemplo: §6§lPREMIUM §6" + p.getName());
                ChatInterativo.Comando(p.getName(), "§a§lLIGHT", "/tag light", "§e(Clique) §7§7Exemplo: §a§lLIGHT §a" + p.getName());
                ChatInterativo.Comando(p.getName(), "§7§lNORMAL", "/tag normal", "§e(Clique) §7§7Exemplo: §7" + p.getName());
            ...
            if (p.hasPermission("tag.developer")) {
                p.sendMessage("§d§lTAGS §7Voc\u00ea possui as tags:");
                p.sendMessage("§E");
                ChatInterativo.Comando(p.getName(), "§3§lDEVELOPER", "/tag developer", "§e(Clique) §7§7Exemplo: §3§lDEVELOPER §7" + p.getName());
                ChatInterativo.Comando(p.getName(), "§c§lADMIN", "/tag admin", "§e(Clique) §7§7Exemplo: §c§lADMIN §c" + p.getName());
                ChatInterativo.Comando(p.getName(), "§c§lGERENTE", "/tag gerente", "§e(Clique) §7§7Exemplo: §c§lGERENTE §c" + p.getName());
                ChatInterativo.Comando(p.getName(), "§5§lMOD+", "/tag modplus", "§e(Clique) §7§7Exemplo: §5§lMODPLUS §5" + p.getName());
                ChatInterativo.Comando(p.getName(), "§5§lMOD", "/tag mod", "§e(Clique) §7§7Exemplo: §5§lMOD §5" + p.getName());
